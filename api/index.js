    ...
    for (const m of messages) {
      if (typeof m.content === 'string') {
        ...
        for (const c of m.content) {
          ...
          // Imagem base64 (redação manuscrita, etc.)
